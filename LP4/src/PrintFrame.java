...
public class PrintFrame extends JFrame implements Printable {
    ...
    private PrintFrame() {
        ...
        centerX = getWidth() / 2;
        centerY = getHeight() / 2;
        pie = new MyStroke(0, 0, getWidth(), getHeight(), getWidth() / 4);
        textLines = initTextLines(new File("src/MyLine.java"));
    }
    ...
    public int print(Graphics graphics, PageFormat pageFormat, int pageIndex) throws PrinterException {
        ...
        if (pageIndex == 0) {
            ...
            graphics.drawImage(scaledImage, (int) (pageFormat.getImageableWidth() / 2 - 75), (int) (pageFormat.getImageableHeight() / 40 + 100), null);
            return PAGE_EXISTS;
        }
        if (pageBreaks == null) {
