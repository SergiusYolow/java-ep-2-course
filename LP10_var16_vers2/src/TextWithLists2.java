 ...
 **/
public class TextWithLists2 extends Panel
{
     ...
     */
    public TextWithLists2(String StaticText, char key, String[] list1, String[] list2)
    {
    ...
    public static void main(String[] args)
    {
        ...
        TextWithLists2 p = new TextWithLists2();
