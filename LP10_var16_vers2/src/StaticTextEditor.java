...
public class StaticTextEditor extends PropertyEditorSupport
{
    ...
    {
        Object o = getValue();
        String res = "com.davidflanagan.examples.beans.StaticText";
        if (o == "STATIC TEXT")
            return "com.davidflanagan.examples.beans.StaticText1";
        if (o == "Sergey")
            return "com.davidflanagan.examples.beans.StaticText2";
        if (o == "Rumdan")
            return "com.davidflanagan.examples.beans.StaticText3";
        if (o == "Sergey Rudman Prod.")
            return "com.davidflanagan.examples.beans.StaticText4";
        return null;
    }
}
